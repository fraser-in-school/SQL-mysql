...
CREATE TABLE `base_channel`  (
  ...
  `created_by_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '创建人',
  ...
  `updated_by_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '更新人',
...
CREATE TABLE `base_org`  (
  ...
  `is_availability` int(10) DEFAULT 1 COMMENT '是否有效 是否有效：0、无效；1、有效；',
  `version` int(10) DEFAULT NULL COMMENT '版本号',
  `created_by_id` bigint(19) DEFAULT NULL COMMENT '创建人',
  `created_by_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '创建人名称',
  `created_time` datetime(0) DEFAULT NULL COMMENT '创建时间',
  `updated_by_id` bigint(19) DEFAULT NULL COMMENT '更新人',
  `updated_by_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '更新人名称',
  `updated_time` datetime(0) DEFAULT NULL COMMENT '更新时间',
  `platform` varchar(2) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '平台 平台：1、拜博；2、养康',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `base_rights`  (
  ...
  `is_availability` int(10) DEFAULT 1 COMMENT '是否有效 是否有效：0、无效；1、有效；',
  `version` int(10) DEFAULT NULL COMMENT '版本号',
  `created_by_id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '创建人',
  `created_by_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '创建人名称',
  `created_time` datetime(0) DEFAULT NULL COMMENT '创建时间',
  `updated_by_id` bigint(19) DEFAULT NULL COMMENT '更新人',
  `updated_by_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '更新人名称',
...
CREATE TABLE `bybo_items`  (
  ...
  `created_by_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  ...
  `updated_by_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
CREATE TABLE `card`  (
  ...
  `card_no` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '卡号',
  `password` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '卡密',
  ...
  `created_by_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '创建人名称',
  `created_time` datetime(0) DEFAULT NULL COMMENT '创建时间',
  `updated_by_id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '更新人',
  `updated_by_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '更新人名称',
  `updated_time` datetime(0) DEFAULT NULL COMMENT '更新时间',
  `platform` varchar(2) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '平台 平台：1、拜博；2、养康',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `card_active`  (
  ...
  `active_by_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '激活人姓名',
...
CREATE TABLE `card_life_logs`  (
  `id` bigint(19) NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `card_id` bigint(19) DEFAULT NULL COMMENT '卡号',
  `card_no` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '卡号',
...
CREATE TABLE `template`  (
  ...
  `is_availability` int(11) DEFAULT 1 COMMENT '是否有效 是否有效：0、无效；1、有效；',
  `version` int(11) DEFAULT NULL COMMENT '版本号',
  `created_by_id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '鍒涘缓浜�',
  `created_by_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '创建人名称',
  `created_time` datetime(0) DEFAULT NULL COMMENT '创建时间',
  `updated_by_id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '更新人',
  `updated_by_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '更新人名称',
